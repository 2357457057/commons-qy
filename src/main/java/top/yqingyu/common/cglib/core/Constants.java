...
public interface Constants extends top.yqingyu.common.asm.Opcodes {
    ...
    public static final Type TYPE_SIGNATURE = TypeUtils.parseType("top.yqingyu.common.cglib.core.Signature");
