...
implements CallbackGenerator
{
    ...
    private static final Type REFLECT_UTILS =
      TypeUtils.parseType("top.yqingyu.common.cglib.core.ReflectUtils");
    private static final Type METHOD_PROXY =
      TypeUtils.parseType("top.yqingyu.common.cglib.proxy.MethodProxy");
    private static final Type METHOD_INTERCEPTOR =
      TypeUtils.parseType("top.yqingyu.common.cglib.proxy.MethodInterceptor");
