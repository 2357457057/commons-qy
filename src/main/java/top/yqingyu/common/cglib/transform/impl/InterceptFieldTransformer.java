...
public class InterceptFieldTransformer extends ClassEmitterTransformer {
    ...
    private static final Type CALLBACK =
      TypeUtils.parseType("top.yqingyu.common.cglib.transform.impl.InterceptFieldCallback");
    private static final Type ENABLED =
      TypeUtils.parseType("top.yqingyu.common.cglib.transform.impl.InterceptFieldEnabled");
