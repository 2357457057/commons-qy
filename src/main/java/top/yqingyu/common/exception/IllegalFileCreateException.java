...
public class IllegalFileCreateException extends RuntimeException {
     ...
     */
    public IllegalFileCreateException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public IllegalFileCreateException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.7
     */
    protected IllegalFileCreateException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
