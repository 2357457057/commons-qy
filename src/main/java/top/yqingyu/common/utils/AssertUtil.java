...
public class AssertUtil {
    ...
    public static void isTrue(boolean expression, String errorMsgTemplate, Object... params) throws IllegalArgumentException {
        isTrue(expression, () -> new IllegalArgumentException(StringUtil.fillBrace(errorMsgTemplate, params)));
    }
    ...
    public static void isFalse(boolean expression, String errorMsgTemplate, Object... params) throws IllegalArgumentException {
        isFalse(expression, () -> new IllegalArgumentException(StringUtil.fillBrace(errorMsgTemplate, params)));
    }
    ...
    public static void isNull(Object object, String errorMsgTemplate, Object... params) throws IllegalArgumentException {
        isNull(object, () -> new IllegalArgumentException(StringUtil.fillBrace(errorMsgTemplate, params)));
    }
    ...
    public static <T> T notNull(T object, String errorMsgTemplate, Object... params) throws IllegalArgumentException {
        return notNull(object, () -> new IllegalArgumentException(StringUtil.fillBrace(errorMsgTemplate, params)));
    }
    ...
    public static <T extends CharSequence> T notEmpty(T text, String errorMsgTemplate, Object... params) throws IllegalArgumentException {
        return notEmpty(text, () -> new IllegalArgumentException(StringUtil.fillBrace(errorMsgTemplate, params)));
    }
    ...
    public static <T extends CharSequence> T notBlank(T text, String errorMsgTemplate, Object... params) throws IllegalArgumentException {
        return notBlank(text, () -> new IllegalArgumentException(StringUtil.fillBrace(errorMsgTemplate, params)));
    }
    ...
    public static String notContain(String textToSearch, String substring, String errorMsgTemplate, Object... params) throws IllegalArgumentException {
        return notContain(textToSearch, substring, () -> new IllegalArgumentException(StringUtil.fillBrace(errorMsgTemplate, params)));
    }
    ...
    public static <T> T[] notEmpty(T[] array, String errorMsgTemplate, Object... params) throws IllegalArgumentException {
        return notEmpty(array, () -> new IllegalArgumentException(StringUtil.fillBrace(errorMsgTemplate, params)));
    }
    ...
    public static <T> T[] noNullElements(T[] array, String errorMsgTemplate, Object... params) throws IllegalArgumentException {
        return noNullElements(array, () -> new IllegalArgumentException(StringUtil.fillBrace(errorMsgTemplate, params)));
    }
     ...
     * @since 5.4.5
     */
    public static <X extends Throwable> Collection<?> notEmpty(Collection<?> collection, Supplier<X> errorSupplier) throws X {
     ...
     */
    public static Collection<?> notEmpty(Collection<?> collection, String errorMsgTemplate, Object... params) throws IllegalArgumentException {
        return notEmpty(collection, () -> new IllegalArgumentException(StringUtil.fillBrace(errorMsgTemplate, params)));
    }
     ...
     * @see CollectionUtil#isNotEmpty(Map)
     * @since 5.4.5
     */
    ...
    public static <K, V, T extends Map<K, V>> T notEmpty(T map, String errorMsgTemplate, Object... params) throws IllegalArgumentException {
        return notEmpty(map, () -> new IllegalArgumentException(StringUtil.fillBrace(errorMsgTemplate, params)));
    }
    ...
    public static <T> T isInstanceOf(Class<?> type, T obj, String errorMsgTemplate, Object... params) throws IllegalArgumentException {
        ...
        if (!type.isInstance(obj)) {
            throw new IllegalArgumentException(StringUtil.fillBrace(errorMsgTemplate, params));
        }
        return obj;
    }
    ...
    public static void state(boolean expression, String errorMsgTemplate, Object... params) throws IllegalStateException {
        if (!expression) {
            throw new IllegalStateException(StringUtil.fillBrace(errorMsgTemplate, params));
        }
    }
    ...
    public static int checkBetween(int value, int min, int max, String errorMsgTemplate, Object... params) {
        return checkBetween(value, min, max, () -> new IllegalArgumentException(StringUtil.fillBrace(errorMsgTemplate, params)));
    }
    ...
    public static Number checkBetween(Number value, Number min, Number max) {
        ...
        if (valueDouble < minDouble || valueDouble > maxDouble) {
            throw new IllegalArgumentException(StringUtil.fillBrace(TEMPLATE_VALUE_MUST_BE_BETWEEN_AND, min, max));
        }
        return value;
    }
    ...
    public static void notEquals(Object obj1, Object obj2, String errorMsgTemplate, Object... params) throws IllegalArgumentException {
        notEquals(obj1, obj2, () -> new IllegalArgumentException(StringUtil.fillBrace(errorMsgTemplate, params)));
    }
    ...
    public static <X extends Throwable> void notEquals(Object obj1, Object obj2, Supplier<X> errorSupplier) throws X {
        if (ObjectUtil.nullSafeEquals(obj1, obj2)) {
            throw errorSupplier.get();
        }
    }
    // ----------------------------------------------------------------------------------------------------------- Check not equals
    ...
    public static void equals(Object obj1, Object obj2, String errorMsgTemplate, Object... params) throws IllegalArgumentException {
        equals(obj1, obj2, () -> new IllegalArgumentException(StringUtil.fillBrace(errorMsgTemplate, params)));
    }
    ...
    private static String badIndexMsg(int index, int size, String desc, Object... params) {
        if (index < 0) {
            return StringUtil.fillBrace("{} ({}) must not be negative", StringUtil.fillBrace(desc, params), index);
        } else if (size < 0) {
            throw new IllegalArgumentException("negative size: " + size);
        } else { // index >= size
            return StringUtil.fillBrace("{} ({}) must be less than size ({})", StringUtil.fillBrace(desc, params), index, size);
        }
    }
    // -------------------------------------------------------------------------------------------------------------------------------------------- Private method end
}